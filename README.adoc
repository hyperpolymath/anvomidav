https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/anvomidav[image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF
Best Practices]]
...
____
[!IMPORTANT] This project is in the *concept phase*. The repository
contains project infrastructure and governance documents, but no
implementation yet. See ROADMAP for planned development.
____
...
Dual-licensed under link:LICENSE.txt[MIT OR MPL-2.0]. Choose the license
